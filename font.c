...
void drawString( uint8_t *sym, uint16_t x, uint16_t y, uint8_t scale, uint8_t color, char *str ) {
  ...
  for (uint8_t j=0; j<strlen(str); j++) {
   ...
   colorize( (uint16_t)vec, v_sz, color );
